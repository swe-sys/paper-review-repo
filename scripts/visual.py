...
class visual():
    def __init__(self):
        ...
        rospy.Subscriber('/tb3_0/odom',Odometry,self.odom_listener,'/tb3_0/')
        ...
        rospy.Subscriber('/tb3_0/radius',Point,self.radius_listener,'/tb3_0/')
        ...
        rospy.Subscriber('/tb3_0/obs',obs,self.obs_listener,'/tb3_0/')
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        #fig.clf()
        ax.clear()       
        col = {'/tb3_0/':'r','/tb3_1/':'c','/tb3_2/':'b','/tb3_3/':'g','/tb3_4/':'y','/tb3_5/':'m'}
        y.bot_id = list(col.keys())
               #,'/tb3_6/':'k','/tb3_7/':'tab:orange', '/tb3_8/':'tab:purple','/tb3_9/':'tab:olive','/tb3_10/':'tab:gray','/tb3_11/':'tab:pink', '/tb3_12/':'#c9eb34','/tb3_13/':'tab:cyan','/tb3_14/':'aquamarine','/tb3_15/':'mediumseagreen','/tb3_16/':'#FC5A50','/tb3_17/':'#DDA0DD','/tb3_18/':'#FBDD7E','/tb3_19/':'#DBB40C'}
        for i in y.bot_id:
