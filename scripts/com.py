...
class Robot:
    ...
    def __init__(self, id=None, pos=None) -> None:
        ...
        robots.append(self)
        self.cluster = None
        self.namespace = f'tb3_{ROBOT_COUNT}'
        ...
        with open('/home/sweksha/Music/{}.csv'.format(self.namespace),'a+') as f:
            f.write("time,x,y\n" )
    ...
    # def write(self,x,y):
    #     with open('{}/scripts/{}.csv'.format(self.dirname,self.namespace),'a+') as f:
    #         f.write("{},{},{}".format(rospy.get_time(),x,y) + '\n')
    ...
    def odom_callback(self, data):
        ...
        with open('/home/sweksha/Music/{}.csv'.format(self.namespace),'a+') as f:
            f.write("{},{},{}\n".format(rospy.get_time(),self.pos[0],self.pos[1]))
...
class Cluster:
    ...
    def addRobot(self, robot):
        ...
        self.calcState(self.num_robots-1)
