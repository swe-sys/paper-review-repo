...
class robot(object):
    ...
    def scanner(self,msg):       
        ...
        pairs = []
        sobs = [] 
        obstacle_positions = [(-3.0, 8.0), (0.0,0.0), (4.0,4.0), (-5.5, 3.0), (7.8, -0.50), (3.5, -5.0), (-7.0,-2.75)]   
        # creating the pairs
        ...
        try:
            for i in self.cones:
                ...
                if distance < 3 and (-60*pi/180 < angle < 60*pi/180):
                    ...
                    if (global_x, global_y) not in obstacle_positions:
    ...
    def set_goal(self): #,random=False
        ...
        try:  
            if no_neigh >= 1: #and not random:
                ...
                # nearest = np.a[(-3.0, 8.0), (0.0, 0.0), (4.0, 4.0), (-5.5, 3.0), (7.8, -0.50), (3.5, -5.0), (-7.0, -2.75)]:
